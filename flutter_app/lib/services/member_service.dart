...
class MemberService {
  ...
  Future<void> deleteMember(String id) async {
    ...
    try {
      // Note: the DB has ON DELETE RESTRICT on clock_ins → members.
      // If the member has attendance records, Supabase will throw a
      // foreign-key violation. Handle this in the UI with a friendly message.
